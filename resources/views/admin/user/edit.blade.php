...
@section('content')
                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="form-container">
                        ...
                        <div class="form-header">
                            <h2><i class="fas fa-user-plus me-2"></i>Edit User Baru</h2>
                            <p>Perbarui Form Di Bawah Untuk Mengubah Akun Pengguna</p>
                        </div>
                            ...
                            <form id="userForm">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="username" name="username" readonly
                                        style="background-color: rgba(107, 107, 107, 0.397)" value=" {{  old('username', $user->username) }}">
                                </div>
    ...
    @push('script')
        <script src="{{ asset('admin/js/user/update.js') }}"></script>
    @endpush
@endsection
